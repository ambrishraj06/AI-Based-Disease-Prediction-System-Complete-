...
def load_models():
    try:
        ...
        diabetes_model = pickle.load(open('D:/Dieases Predeiction Project/DIABETICS/trained_model_diabetics.sav', 'rb'))
        heart_disease_model = pickle.load(open('D:/Dieases Predeiction Project/HEART/trained_model_heart.sav', 'rb'))
